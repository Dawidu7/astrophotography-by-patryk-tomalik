...
import { SearchSelect, Output, CustomCalculator } from '../../components'
...
const Calculator = () => {
  ...
  const [ customModal, setCustomModal ] = useState<'camera' | 'telescope' | 'flattReduc' | null>(null)
